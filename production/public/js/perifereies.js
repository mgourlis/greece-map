...
function moveInHierarchy(regionObject, enableAnimation, maxAllowdedLevel) {
    ...
    $('#mapLoading').show('fast', async () => {
        ...
        if (getRegionPrefix(regionObject.id) !== 'Δήμος') {
            $('#shareMapText').text('Μοιραστείτε την ' + getRegionPrefix(regionObject.id))
            $('#embededMapText').text('Ενσωματώστε την ' + getRegionPrefix(regionObject.id))
        } else {
            $('#shareMapText').text('Μοιραστείτε τoν  Δήμο')
            $('#embededMapText').text('Ενσωματώστε τoν  Δήμο')
        }
...
async function showTableData() {
    ...
    $('#dataLoading').show('fast', async () => {
        ...
        let header = '<div class="row header"><div class="cell">Πρόγραμμα</div>' +
            ...
            '<div class="cell">Δήμος</div><div class="cell">Περιφέρεια</div><div class="cell">Φιλόδημος</div>' +
        ...
        filteredData.forEach((elem) => {
            ...
            let elemToAppend = '<div class="row"><div class="cell" data-title="Πρόγραμμα">' + elem.program +
                ...
                '</div><div class="cell" data-title="Περιφέρεια">' + elem.regionName +
